...
public class PCMEncoder {
    ...
    public void prepare() {
        ...
        try {
            ...
            Log.e("SONGTest", "Exception while initializing PCMEncoder", e);
        }
    }

    public void stop() {
        Log.e("SONGTest", "Stopping PCMEncoder");
        mediaCodec.stop();
        mediaCodec.release();
        mediaMuxer.stop();
        mediaMuxer.release();
    ...
    public void encode(InputStream inputStream, int sampleRate) throws IOException {
        Log.e("SONGTest", "Starting encoding of InputStream");
        ...
        inputStream.close();
        Log.e("SONGTest", "Finished encoding of InputStream");
    }
}
