...
public class SujeongTestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sujeong_test);
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                InterviewDataItem2 item =(InterviewDataItem2) adapter.getItem(position);
                Intent intent = new Intent(getApplicationContext(), FeddbackDetailActivity.class);
    ...
    public void getFeedbackData() {
        ...
        databaseReference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                //데이터에 추가된 InterviewDataItem2을 가져온다.
                InterviewDataItem2 item = dataSnapshot.getValue(InterviewDataItem2.class);

                //해당 값을 adapter에 추가한다.
                adapter.addItem(item.getTitle(),item.getContent(),item.getDate(),item.getUserId(),item.getFile());
