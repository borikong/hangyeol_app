...
public class Board_InterviewListViewAdapter extends BaseAdapter{

    private ArrayList<InterviewDataItem> listViewItemList = new ArrayList<InterviewDataItem>() ;

    public Board_InterviewListViewAdapter() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        titleTextView.setText("["+listViewItem.getCompany()+"]"+listViewItem.getTitle());
    ...
    // 아이템 데이터 추가를 위한 함수.
    public void addItem(String title, String company, String type, String specific_type, String content,String id,String date) {
